...
b;c++)if(f=d[c],-1<f.name.indexOf(e))return!0;return!1};g.prototype.parseAttributes=function(a,e,f){var c,b,d,l,g,p,n,k,h,m;d=a.attributes;for(l in d)if(null!=d[l]&&"object"===typeof d[l]&&-1!==d[l].name.indexOf("data-")&&-1===d[l].name.indexOf("data-instafeed-")){m=d[l].name.substring(5);c=null;if(-1!==m.indexOf("-"))for(h=m.split("-"),c=e,b=0,p=h.length;b<p;b++)n=h[b],c="data"===n&&null!=c[n][f]?c[n][f]:c[n];if("string"===typeof d[l].value&&(b=d[l].value.split(/\s?,\s?/i),null!=c?k=c:null!=e[m]&&
(k=e[m]),-1!==m.indexOf("created_time")&&(g=k),null!=k&&null!=b&&("string"===typeof k||"number"===typeof k)))for(p=0,n=b.length;p<n;p++)c=b[p],-1!==m.indexOf("created_time")&&(k="datetime"===c?this.dating(g,!0):this.dating(g,!1)),"text"===c.toLowerCase()?a.innerHTML=k:"type"===m&&"image"!==k?a.setAttribute(c,"iframe"):a.setAttribute(c,k)}};g.prototype.arrToString=function(a){return a.join(" ")};g.prototype.dating=function(a,e){var f,c,b,d,g,h;f=new Date(1E3*a);c=new Date;b=parseInt((c.getTime()-f.getTime())/
...
if(3600>b)return parseInt(b/60).toString()+this.options.dateFormat.minutes;if(7200>b)return this.options.dateFormat.hour;if(86400>b)return"about "+parseInt(b/3600).toString()+this.options.dateFormat.hours;if(172800>b)return this.options.dateFormat.day;d=c.match(/%[dmbByY]/g);g=0;for(h=d.length;g<h;g++)b=d[g],c=c.replace(b,f[b]);return c};g.prototype.sortBy=function(a,e,f){a.sort(function(a,b){var d,g;d=this.getObjectProperty(a,e);g=this.getObjectProperty(b,e);return f?d>g?1:-1:d<g?1:-1}.bind(this));
return a};g.prototype.getObjectProperty=function(a,e){var f,c;e=e.replace(/\[(\w+)\]/g,".$1");for(c=e.split(".");c.length;)if(f=c.shift(),null!=a&&f in a)a=a[f];else return null;return a};g.prototype.buildUrl=function(){var a,e,f,c;f=this.element.getAttribute("data-instafeed-get")?this.element.getAttribute("data-instafeed-get"):this.options.get;switch(f){case "popular":a="media/popular";break;case "tagged":a=this.element.getAttribute("data-instafeed-tagname")?this.element.getAttribute("data-instafeed-tagname"):
this.options.tagName;if(!a)throw Error("No tag name specified. Use the 'tagName' option.");a="tags/"+a+"/media/recent";break;case "location":a=this.element.getAttribute("data-instafeed-location")?this.element.getAttribute("data-instafeed-location"):this.options.location;if(!a)throw Error("No location specified. Use the 'locationId' option.");a="locations/"+a+"/media/recent";break;case "user":a=this.element.getAttribute("data-instafeed-user")?this.element.getAttribute("data-instafeed-user"):this.options.userId;
if(!a)throw Error("No user specified. Use the 'userId' option.");a="users/"+a+"/media/recent";break;case "profile":a=this.element.getAttribute("data-instafeed-user")?this.element.getAttribute("data-instafeed-user"):this.options.userId;if(!a)throw Error("No user specified. Use the 'userId' option.");a="users/"+a;break;default:throw Error("Invalid option for get: '"+this.options.get+"'.");}c="https://api.instagram.com/v1/"+a;a=this.element.getAttribute("data-instafeed-accesstoken")?this.element.getAttribute("data-instafeed-accesstoken"):
this.options.accessToken;e=this.element.getAttribute("data-instafeed-clientid")?this.element.getAttribute("data-instafeed-clientid"):this.options.clientId;c=a?c+("?access_token="+a):c+("?client_id="+e);this.$items.length&&"profile"!==f&&(c+="&count="+this.$items.length);return c+="&callback=instafeedCache"+this.unique+".parse"};g.prototype.genKey=function(){var a;a=function(){return(65536*(1+Math.random())|0).toString(16).substring(1)};return""+a()+a()+a()+a()};g.prototype.filter=function(a,e){var f,

...
(function(){(function(h,t,r){var q;q=function(){function g(a,e){this.options=h.extend(!0,{},this.Defaults,e);this.$element=h(a);this.element=a;this.$items=this.$element.find("[data-instafeed-item]");this.unique=this.genKey();this.nextUrl="";this.initialize()}g.prototype.Defaults={accessToken:"3229350923.6c2a967.f972dab346c046f89bb2c0ddb7e8da78",clientId:"f972dab346c046f89bb2c0ddb7e8da78",get:"user",tagName:"awesome",userId:"3229350923",locationId:"",sortBy:"most-recent",useHttp:!1,showLog:"false",
  ...
  d=c.match(/%[dmbByY]/g);g=0;for(h=d.length;g<h;g++)b=d[g],c=c.replace(b,f[b]);return c};g.prototype.sortBy=function(a,e,f){a.sort(function(a,b){var c,g;c=this.getObjectProperty(a,e);g=this.getObjectProperty(b,e);return f?c>g?1:-1:c<g?1:-1}.bind(this));return a};g.prototype.getObjectProperty=function(a,e){var f,c;e=e.replace(/\[(\w+)\]/g,".$1");for(c=e.split(".");c.length;)if(f=c.shift(),null!=a&&f in a)a=a[f];else return null;return a};g.prototype.buildUrl=function(){var a,e,f,c;f=this.element.getAttribute("data-instafeed-get")?
    this.element.getAttribute("data-instafeed-get"):this.options.get;switch(f){case "popular":a="media/popular";break;case "tagged":a=this.element.getAttribute("data-instafeed-tagname")?this.element.getAttribute("data-instafeed-tagname"):this.options.tagName;if(!a)throw Error("No tag name specified. Use the 'tagName' option.");a="tags/"+a+"/media/recent";break;case "location":a=this.element.getAttribute("data-instafeed-location")?this.element.getAttribute("data-instafeed-location"):this.options.location;
  if(!a)throw Error("No location specified. Use the 'locationId' option.");a="locations/"+a+"/media/recent";break;case "user":a=this.element.getAttribute("data-instafeed-user")?this.element.getAttribute("data-instafeed-user"):this.options.userId;if(!a)throw Error("No user specified. Use the 'userId' option.");a="users/"+a+"/media/recent";break;case "profile":a=this.element.getAttribute("data-instafeed-user")?this.element.getAttribute("data-instafeed-user"):this.options.userId;if(!a)throw Error("No user specified. Use the 'userId' option.");
  a="users/"+a;break;default:throw Error("Invalid option for get: '"+this.options.get+"'.");}c="https://api.instagram.com/v1/"+a;a=this.element.getAttribute("data-instafeed-accesstoken")?this.element.getAttribute("data-instafeed-accesstoken"):this.options.accessToken;e=this.element.getAttribute("data-instafeed-clientid")?this.element.getAttribute("data-instafeed-clientid"):this.options.clientId;c=a?c+("?access_token="+a):c+("?client_id="+e);this.$items.length&&"profile"!==f&&(c+="&count="+this.$items.length);
  console.log(c);return c+="&callback=instafeedCache"+this.unique+".parse"};g.prototype.genKey=function(){var a;a=function(){return(65536*(1+Math.random())|0).toString(16).substring(1)};return""+a()+a()+a()+a()};g.prototype.filter=function(a,e){var f,c,b,d,g;f=[];c=function(a){if(e(a))return f.push(a)};d=0;for(g=a.length;d<g;d++)b=a[d],c(b);return f};return g}();h.fn.extend({RDInstafeed:function(g){return this.each(function(){var a;a=h(this);if(!a.data("RDInstafeed"))return a.data("RDInstafeed",new q(this,
    g))})}});return r.RDInstafeed=q})(window.jQuery,document,window);"undefined"!==typeof module&&null!==module?module.exports=window.RDInstafeed:"function"===typeof define&&define.amd&&define(["jquery"],function(){return window.RDInstafeed})}).call(this);
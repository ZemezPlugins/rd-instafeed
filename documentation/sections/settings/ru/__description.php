...
<h5>accessToken
    <sup class='small text-bold'>        *Параметр для разрабочиков    </sup>
</h5>
...
<p>
    Маркер доступа для Instagram API. Используйте этот параметр только если вы знаете для чего он предназначен. В скрипте имеется значение по умолчанию.
</p>
...
<p>
    Идентификатор клиента. Используйте этот параметр только если вы знаете для чего он предназначен. В скрипте имеется значение по умолчанию.
</p>
...
<p>
    Определяет, по какому признаку получать данные с Instagram. Доступно 4 вариантa:
</p>
